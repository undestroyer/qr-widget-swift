...
class AboutView: UIView {
    ...
    private func addLabelsToStack() {
        let contentItems: [LabelsStackItem] = [
            ...
            LabelsStackItem(content: NSLocalizedString("A: Yes, app can detect QR from camera, photos in your gallery and build QR manually with specific content.", comment: "A: Yes, app can detect QR from camera, photos in your gallery and build QR manually with specific content."), spacingAfter: .normal),
